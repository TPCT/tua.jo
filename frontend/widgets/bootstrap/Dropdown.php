...
namespace frontend\widgets\bootstrap;
    ...
    protected function renderItems($items, $options = [])
    {
        ...
        foreach ($items as $item) {
            ...
            if (empty($item['items'])) {
                ...
                $linkOptions['class'] = 'right';
                $content = Html::a($label . '<i class="glyphicon glyphicon-menu-right"></i>', $url === null ? '#' : $url, $linkOptions)
                    . $this->renderItems($item['items'], $submenuOptions);
//                Html::addCssClass($itemOptions, ['widget' => 'inner-drop']);
            }

            $lines[] = Html::tag('li', $content, $itemOptions);
        }

        return Html::tag('ul', implode("\n", $lines), ['class' => 'Dropdown-menu inner-drop', 'id' => 'navbarDropdown']);
    }
}
