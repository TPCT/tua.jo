...
$this->title = Yii::t('site', 'E_CARD_STEP_2_TITLE');
$this->description = Yii::t('site', 'E_CARD_STEP_2_TITLE_DESCRIPTION');
    ...
    <div class=" ecard-main-container">
        ...
        <div class="ecard-step-content">
          <h4><?=Yii::t('site', 'Pay with Visa / Mastercard')?></h4>
            <form action="<?=\yii\helpers\Url::to(['/payment/hyper-pay-handler/?type=e-card'], true)?>" class="paymentWidgets mt-5" data-brands="VISA MASTER AMEX"></form>
