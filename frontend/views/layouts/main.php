...
<main id="Home" class="<?= (Yii::$app->language == 'en') ? '' : 'arabic-version' ; ?>" >


    <?= Yii::$app->controller->renderPartial('@app/views/layouts/_header', []) ?>
...
<div class="toast text-white hide" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="toast-body text-white ">
        ...
        <span class="message w-100 text-white "></span>
    </div>
</div>
