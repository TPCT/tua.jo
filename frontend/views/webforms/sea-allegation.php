...
$this->title = Yii::t('site', 'SEA_ALLEGATION');
$this->description = Yii::t('site', 'SEA_ALLEGATION_DESCRIPTION');
...
<?= HeaderImage::widget(['is_inner'=> true , 'path'=>'/sea-allegation' ]) ?>
...
<?php if($seaAllegationFirstSection): ?>

        <div class="container centerd-section-topic">
            <h3> <?= $seaAllegationFirstSection->title ?></h3>
            <?= $seaAllegationFirstSection->content ?>
        </div>
        <?php endif; ?>
              ...
              <ul>
                ...
                <div class="d-flex flex-column w-100  align-items-start justify-content-start">
                  <div class="row w-100 px-0 g-4 pt-3 pb-5">
                    <h4> 1- <?= Yii::t("site", "YOUR_INFORMATION") ?>  <span><?= Yii::t("site", "IF_DESIGRED") ?></span></h4>
                    ...
                    <div class="col-lg-6 col-12 d-flex flex-column gap-3">
                      ...
                      <?= $form->field($model, 'email')->textInput([  'class' => false, 'maxlength' => true,'placeholder' => Yii::t("site", "SEA_ALLEGATION_EMAIL_PLACE_HOLDER")])->label(); ?>

                    </div>
                    <div class="col-lg-6 col-12 d-flex flex-column gap-3">

                    <?= $form->field($model, 'contact_method_id')->dropDownList($model->getSeaAllegationList(), ["prompt" => Yii::t("site", "PURPOSE_OF_CONTACT"), "class" => 'form-select'])
                        ->label(); ?>
                    </div>
                    <h4> 2- <?= Yii::t("site", "INCIDENT_DETAIL") ?>  </h4>
                    <div class="col-lg-6 col-12 d-flex flex-column gap-3">
                      <label for="date"> <?= Yii::t("site", "DATE_OF_INCIDEN") ?> <span class="optional"> (<?= Yii::t('site','OPTIONAL') ?>) </span> </label>
                      <input type="date" name="SeaAllegationWebform[inciden_date]" id="date" placeholder=" DD/MM/YYYY ">
                    ...
                    <div class="col-lg-6 col-12 d-flex flex-column gap-3">
                      <label for="name"> <?= Yii::t("site", "LOCATION_OF_INCIDEN")?> <span class="optional"> (<?= Yii::t("site", "OPTIONAL") ?>) </span> </label>
                    ...
                    <h4>6-  <?=  Yii::t("site", "ADDITIONAL_INFORMATION") ?> : </h4>

                    <div class=" col-12 d-flex flex-column gap-3">

                    <?= $form->field($model, 'additional_information')->textarea([ 'maxlength' => true, 'id' => "exampleFormControlTextarea1", 'placeholder' => Yii::t("site", "TYPE_HERE"), 'rows' => 5])->label() ?>
