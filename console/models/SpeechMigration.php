 ...
 */
class SpeechMigration extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['nid', 'tnid', 'title', 'language', 'body', 'body_summary', 'field_date', 'field_selected_speeches', 'field_pre_title1', 'field_flag_speeches', 'field_videos_path', 'field_trailer_1', 'city_name', 'field_trailer_2', 'url_alias', 'published_status', 'country_name'], 'safe'],
        ];
    }
