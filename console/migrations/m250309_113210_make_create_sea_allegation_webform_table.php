...
class m250309_113210_make_create_sea_allegation_webform_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->createTable('sea_allegation_webform', [
            'id' => $this->primaryKey(),
        ...
        $this->createIndex(
            'idx-sea_allegation_webform-contact_method_id',
            'sea_allegation_webform',
            'contact_method_id'
        );
        $this->addForeignKey(
            'fk-sea_allegation_webform-contact_method_id',
            'sea_allegation_webform',
            'contact_method_id',
            'dropdown_list',
            'id',
    ...
    {
        echo "m250309_113210_make_create_sea_allegation_webform_table cannot be reverted.\n";
