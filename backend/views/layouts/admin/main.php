...
<div class="wrap">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        NavBar::begin([
            'brandLabel' => Html::img($logo, ['class' => 'yee-logo']),
        ...
        $menuItems[] = ['label' => Yii::t('site', '<i class="fa fa-refresh" aria-hidden="true"></i>'), 'url' => ['/settings/cache/flush']];
        ...
        LanguageSelector::widget(['display' => 'label', 'view' => 'pills']);
                        ...
                        try {
                            echo PrintThis::widget([
                                ...
                                'options' => [
                                    ...
                                    'importCSS' => true,
                                    'importStyle' => false,
                                    //'loadCSS' => "http://kinzyiiportal.local:8089/scss",
                                    'pageTitle' => "",
                                    'removeInline' => false,
                                    'printDelay' => 200,
                                    'header' => null,
