            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <?= $form->field($model, 'backgroumd_image')->widget(yeesoft\media\widgets\FileInput::className(), [
                                'name' => 'backgroumd_image',
                                'buttonTag' => 'button',
                                'buttonName' => Yii::t('site', 'Browse'),
                                'buttonOptions' => ['class' => 'btn btn-default btn-file-input'],
                                'options' => ['class' => 'form-control for-img'],
                                'template' => '<div class="news-backgroumd_image thumbnail"></div><div class="input-group">{input}<span class="input-group-btn">{button}</span></div>',
                                'thumb' => $this->context->module->thumbnailSize,
                                'imageContainer' => '.news-backgroumd_image',
                                'pasteData' => yeesoft\media\widgets\FileInput::DATA_URL,
                                'callbackBeforeInsert' => 'function(e, data) {
                                $(".news-backgroumd_image").show();
                            }',
                            ]) ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="record-info">
                            ...
                            <?= $form->field($model, 'promoted_to_front')->checkbox() ?>

                            <?php if( $model->canMakerSeeStatus() ): ?>
                                <?= $form->field($model, 'status')->dropDownList(PromotedCampaign::getStatusList()) ?>
                            <?php endif; ?>
