...
class ProtectionWebform extends \yii\db\ActiveRecord
{
    public $reCaptcha;
    ...
    public function rules()
    {
        return [
            ...
            [['reCaptcha','mobile_number','contact_method_id','inciden_date','location','description'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('site', 'ID'),
            'name' => Yii::t('site', 'PROTECTION_NAME'),
            'email' => Yii::t('site', 'PROTECTION_EMAIL'),
            ...
            'additional_information' => Yii::t('site', 'ADDITIONAL_INFORMATION'),


        ];
    }
    public function getProtectionContactMethod()
    {
        return $this->hasOne(DropdownList::className(), ['id' => 'contact_method_id']);
    }

    public static function getProtectionContactMethodList()
    {
    ...
    public function sendEmail($email)
    {
        ...
        try 
        {
            ...
            $message = Yii::$app->mailer->compose()
                ...
                ->setSubject('Career Protection Form ' . $this->name . '<' . $this->email . '>')
                ->setHtmlBody($output)
                ->setTextBody('--');
