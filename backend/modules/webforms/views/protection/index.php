...
$this->title = 'Protection Webforms';
$this->params['breadcrumbs'][] = $this->title;

$params = array_merge(['/webforms/protection/index/'],$_GET, array('Export'=>'1'));
...
HTML;
            ...
            $form = ActiveForm::begin([
                ...
                'method' => 'GET',
                'action' => ['/webforms/protection/index']
            ]);
            ...
            $columns =
                [
                    ...
                    [
                        ...
                        'controller' => '/webforms/protection',
                        'title' => function (ProtectionWebform $model) {
