...
$this->title = 'ComplainT Us Webforms';
$this->params['breadcrumbs'][] = $this->title;

$params = array_merge(['/webforms/complaint/index/'],$_GET, array('Export'=>'1'));
...
HTML;
            ...
            $form = ActiveForm::begin([
                ...
                'method' => 'GET',
                'action' => ['/webforms/complaint/index']
            ]);
            ...
            $columns =
                [
                    ...
                    [
                        ...
                        'controller' => '/webforms/complaint',
                        'title' => function (ComplaintWebform $model) {
