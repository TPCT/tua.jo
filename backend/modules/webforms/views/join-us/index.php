...
$this->title = 'Join Us Webforms';
$this->params['breadcrumbs'][] = $this->title;

$params = array_merge(['/webforms/join-us/index/'],$_GET, array('Export'=>'1'));
            ...
            $columns =
                [
                    ...
                    [
                        ...
                        'controller' => '/webforms/join-us',
                        'title' => function (JoinUsWebform $model) {
                            return Html::a($model->name, Url::to(['view', 'id' => $model->id],true) , ['data-pjax' => 0]);
                        },
                        'buttonsTemplate' => '',
                    ],
                    [
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            ...
                            return preg_replace('/(\d{3})(\d{3})(\d{4})/', '($1) $2-$3', $model->mobile_number);
                        },
                    ],
                    ...
                    [
                        ...
                        'format' => 'raw',
                        'value' => function($model){
                            return $model->cv  ? Html::a('Download', Url::to($model->cv,true), ['target' => '_blank', 'download' => 'download']) : '';
                        }
                    ],
                    'created_at' => [
