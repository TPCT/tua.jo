...
$this->title = 'Sea Allegation Webforms';
$this->params['breadcrumbs'][] = $this->title;

$params = array_merge(['/webforms/sea-allegation/index/'],$_GET, array('Export'=>'1'));
...
HTML;
            ...
            $form = ActiveForm::begin([
                ...
                'method' => 'GET',
                'action' => ['/webforms/sea-allegation/index']
            ]);
            ...
            $columns =
                [
                    ...
                    [
                        ...
                        'controller' => '/webforms/sea-allegation',
                        'title' => function (SeaAllegationWebform $model) {
