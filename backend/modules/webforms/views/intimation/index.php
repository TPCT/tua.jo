...
$this->title = 'intimation Us Webforms';
$this->params['breadcrumbs'][] = $this->title;

$params = array_merge(['/webforms/intimation/index/'],$_GET, array('Export'=>'1'));
...
HTML;
            ...
            $form = ActiveForm::begin([
                ...
                'method' => 'GET',
                'action' => ['/webforms/IntimationWebform/index']
            ]);
            ...
            $columns =
                [
                    ...
                    [
                        ...
                        'controller' => '/webforms/IntimationWebform',
                        'title' => function (IntimationWebform $model) {
                            return Html::a($model->inimation_webform, ['view', 'id' => $model->id], ['data-pjax' => 0]);
                        },
                        'buttonsTemplate' => '',
                    ],
...
//                        GridView::PDF => $pdfConfig
                ...
                'options' => ['id' => 'IntimationWebform-us-report'] // a unique identifier is important
            ]);
            DynaGrid::end();
            ?>
        </div>
