...
/**
 * RatingController implements the CRUD actions for backend\modules\webforms\models\ContactUsWebform model.
 */
class RatingController extends BaseController
{
    public $modelClass       = 'backend\modules\webforms\models\RatingWebform';
    public $modelSearchClass = 'backend\modules\webforms\models\search\RatingWebformSearch';
