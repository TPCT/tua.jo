...
/**
 * SeaAllegationController implements the CRUD actions for backend\modules\webforms\models\ContactUsWebform model.
 */
class SeaAllegationController extends BaseController
{
    public $modelClass       = 'backend\modules\webforms\models\SeaAllegationWebform';
    public $modelSearchClass = 'backend\modules\webforms\models\search\SeaAllegationWebformSearch';
