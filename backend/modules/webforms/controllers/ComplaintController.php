...
/**
 * ComplaintController implements the CRUD actions for backend\modules\webforms\models\ComplaintController model.
 */
class ComplaintController extends BaseController
{
    public $modelClass       = 'backend\modules\webforms\models\ComplaintWebform';
    public $modelSearchClass = 'backend\modules\webforms\models\search\ComplaintWebformSearch';
