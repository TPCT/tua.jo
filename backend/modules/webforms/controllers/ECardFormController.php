...
/**
 * ECardFormController implements the CRUD actions for backend\modules\webforms\models\ECardFormController model.
 */
class ECardFormController extends BaseController
{
    public $modelClass       = 'backend\modules\webforms\models\ECardFormWebform';
    public $modelSearchClass = 'backend\modules\webforms\models\search\ECardFormWebformSearch';
