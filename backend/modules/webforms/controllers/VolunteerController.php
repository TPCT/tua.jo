...
/**
 * VolunteerController implements the CRUD actions for backend\modules\webforms\models\ContactUsWebform model.
 */
class VolunteerController extends BaseController
{
    public $modelClass       = 'backend\modules\webforms\models\VolunteerWebform';
    public $modelSearchClass = 'backend\modules\webforms\models\search\VolunteerWebformSearch';
