...
/**
 * ContactUsController implements the CRUD actions for backend\modules\webforms\models\ContactUsWebform model.
 */
class RequestVisitController extends BaseController
{
    public $modelClass       = 'backend\modules\webforms\models\RequestVisitWebform';
    public $modelSearchClass = 'backend\modules\webforms\models\search\RequestVisitWebformSearch';
