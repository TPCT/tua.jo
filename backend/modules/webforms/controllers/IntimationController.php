...
/**
 * IntimationController implements the CRUD actions for backend\modules\webforms\models\IntimationWebform model.
 */
class IntimationController extends BaseController
{
    public $modelClass       = 'backend\modules\webforms\models\IntimationWebform';
    public $modelSearchClass = 'backend\modules\webforms\models\search\IntimationWebformSearch';
    ...
    public function actionIndex()
    {
        ...
        if (Yii::$app->request->get('Export')) {
            ...
            $exporter->send('IntimationWebformSearch.xls');
        }
