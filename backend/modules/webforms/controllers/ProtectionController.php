...
/**
 * ProtectionController implements the CRUD actions for backend\modules\webforms\models\ContactUsWebform model.
 */
class ProtectionController extends BaseController
{
    public $modelClass       = 'backend\modules\webforms\models\ProtectionWebform';
    public $modelSearchClass = 'backend\modules\webforms\models\search\ProtectionWebformSearch';
