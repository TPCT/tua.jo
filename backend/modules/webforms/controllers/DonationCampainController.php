...
/**
 * DonationCampainController implements the CRUD actions for backend\modules\webforms\models\ContactUsWebform model.
 */
class DonationCampainController extends BaseController
{
    public $modelClass       = 'backend\modules\webforms\models\DonationCampainWebform';
    public $modelSearchClass = 'backend\modules\webforms\models\search\DonationCampainWebformSearch';
