...
/**
 * JoinUsController implements the CRUD actions for backend\modules\webforms\models\ContactUsWebform model.
 */
class JoinUsController extends BaseController
{
    public $modelClass       = 'backend\modules\webforms\models\JoinUsWebform';
    public $modelSearchClass = 'backend\modules\webforms\models\search\JoinUsWebformSearch';
