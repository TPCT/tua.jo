...
namespace backend\modules\donation_types\controllers;
...
{
    public $modelClass = 'backend\modules\donation_types\models\DonationTypes';
    public $modelSearchClass = 'backend\modules\donation_types\models\search\DonationTypesSearch';
