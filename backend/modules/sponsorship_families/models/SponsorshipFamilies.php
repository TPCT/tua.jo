...
/**
 * This is the model class for table "SponsorshipFamilies".
 *
 * @property int $id
...
class SponsorshipFamilies extends ActiveRecord
{
    use RevisionTrait;
    ...
    public function behaviors()
    {
        return [
            ...
            'multilingual' => [
                ...
                'langClassName' => SponsorshipFamiliesLang::className(),
                'tableName' => "{{%sponsorship_families_lang}}",
                'attributes' => [
                    'title','story','header_image','header_mobile_image','header_image_title'
    ...
    public function rules()
    {
        return [
            [
                [
                    'title','story','slug' ,'published_at','status','weight','image',
                    'object_fit', 'object_position','header_image','header_mobile_image','header_image_title'
                    ,'header_image_brief','guid','image','gender', 'sponsored', 'donation_type_id'
                ], function ($attribute) 
                {
            ...
            [['title','image','guid', 'donation_type_id'], 'required'],
            [['age'],'number'],
            [['slug'], 'unique'],

            [['weight', 'status', 'sponsored', 'revision','changed', 'created_by', 'updated_by','donation_type_id'
        ], 'integer'],
            [   
                [
    ...
    public function attributeLabels()
    {
        return [
            ...
            'sponsored' => Yii::t('site', 'Sponsored'),
    ...
    /**
     * {@inheritdoc}
     * @return SponsorshipFamiliesQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new SponsorshipFamiliesQuery(get_called_class());
    }


    public function getSponsorshipFamiliesLang()
    {
        return $this->hasMany(SponsorshipFamiliesLang::class, ['parent_id' => 'id']);
    }
    ...
    public function getDonationType()
    {
        return $this->hasOne(DonationTypes::class,['id' => 'donation_type_id'])
                    ...
                    ->onCondition([
                        DonationTypes::tableName().'.status' => DonationTypes::STATUS_PUBLISHED
                    ]);
    }
