            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <?= $form->field($model, 'story')->textInput(['maxlength' => true]) ?>
            ...
            <div class="col-md-3">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <?= $form->field($model, 'gender')->dropDownList(SponsorshipFamilies::getGenderList(), ['class' => 'form-select']) ?>


                        <?php if ($model->canMakerSeeStatus()): ?>
                            <?= $form->field($model, 'status')->dropDownList(SponsorshipFamilies::getStatusList(), ['class' => 'form-select']) ?>
                        <?php endif; ?>
