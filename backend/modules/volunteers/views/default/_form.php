...
/* @var $model \backend\modules\volunteers\models\Volunteers */
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        ->hint('Aspect Ratio Should be 56 / 33 if not try to change object fit and object postion') ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <?= $form->field($model, 'file_label')->textInput(['maxlength' => true]) ?>
                            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="record-info">
                            ...
                            <?= $form->field($model, 'promoted_to_volunteer')->checkbox() ?>


                            <?php if( $model->canMakerSeeStatus() ): ?>
                                <?= $form->field($model, 'status')->dropDownList(Volunteers::getStatusList()) ?>
                            <?php endif; ?>
