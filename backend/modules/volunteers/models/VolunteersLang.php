...
/**
 * This is the model class for table "volunteers_lang".
 *
 * @property int $id
 ...
 *
 * @property Volunteers $parent
 */

class VolunteersLang extends \yii\db\ActiveRecord
{
...
//            [['parent_id'], 'exist', 'skipOnError' => true, 'targetClass' => News::class, 'targetAttribute' => ['parent_id' => 'id']],
    ...
    {
        return $this->hasOne(Volunteers::class, ['id' => 'parent_id']);
    }
