...
/**
 * DefaultController implements the CRUD actions for common\models\blogs model.
 */
class DefaultController extends BaseController
{
    public $modelClass = 'backend\modules\blogs\models\Blogs';
    public $modelSearchClass = 'backend\modules\blogs\models\search\BlogsSearch';

    public $seoModelClass = 'yeesoft\seo\models\Seo';
    public $frontUrl= "/blogs/";
