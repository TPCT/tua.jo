...
$this->title = Yii::t('site', 'Donation Programs');
            ...
            <div class="row">
                <div class="col-sm-6">
                    <?= GridQuickLinks::widget([
                        'model' => \backend\modules\donation_programs\models\DonationProgram::className(),
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function (\backend\modules\donation_programs\models\DonationProgram $model) {
