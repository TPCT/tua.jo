...
namespace backend\modules\beneficiaries_countries\controllers;
...
/**
 * DefaultController implements the CRUD actions for common\models\BeneficiariesCountries model.
 */
class DefaultController extends BaseController
{
    public $modelClass = 'backend\modules\beneficiaries_countries\models\BeneficiariesCountries';
    public $modelSearchClass = 'backend\modules\beneficiaries_countries\models\search\BeneficiariesCountriesSearch';
