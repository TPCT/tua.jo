...
/* @var $model \backend\modules\BeneficiariesCountries\models\BeneficiariesCountries */

$this->title = $model->title;
$this->params['breadcrumbs'][] = ['label' => Yii::t('site', 'Beneficiaries Countries'), 'url' => ['index']];
