...
/* @var $model BeneficiariesCountries */
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <?= $form->field($model, 'img')->widget(yeesoft\media\widgets\FileInput::className(), [
                                'name' => 'image',
                                'buttonTag' => 'button',
                    ...
                    <div class="panel-body">
                        ...
                        <div class="record-info">
                            ...
                            <?php if( $model->canMakerSeeStatus() ): ?>
                                <?= $form->field($model, 'status')->dropDownList(BeneficiariesCountries::getStatusList(), ['class'=>'form-select']) ?>
                            <?php endif; ?>
