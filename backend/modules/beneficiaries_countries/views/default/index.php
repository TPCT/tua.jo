...
/* @var $searchModel \backend\modules\beneficiaries_countries\models\search\BmsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('site', 'beneficiaries countries');
            ...
            <div class="row">
                <div class="col-sm-6">
                    <?= GridQuickLinks::widget([
                        'model' => BeneficiariesCountries::className(),
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function (BeneficiariesCountries $model) {
