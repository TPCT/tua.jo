...
namespace backend\modules\annual_report\controllers;
...
/**
 * DefaultController implements the CRUD actions for common\models\AnnualReport model.
 */
class DefaultController extends BaseController
{
    public $modelClass = 'backend\modules\annual_report\models\AnnualReport';
    public $modelSearchClass = 'backend\modules\annual_report\models\search\AnnualReportSearch';
