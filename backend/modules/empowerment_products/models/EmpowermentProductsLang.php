 ...
 *
 * @property EmpowermentProductsLang    $parent
 */

class EmpowermentProductsLang extends \yii\db\ActiveRecord
{
    ...
    {
        return 'empowerment_product_lang';
    }
...
//            [['parent_id'], 'exist', 'skipOnError' => true, 'targetClass' => News::class, 'targetAttribute' => ['parent_id' => 'id']],
    ...
    {
        return $this->hasOne(EmpowermentProducts::class, ['id' => 'parent_id']);
    }
