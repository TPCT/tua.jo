 ...
 */
class EmpowermentProducts extends ActiveRecord
{
    ...
    public function behaviors()
    {
        return [
            ...
            'multilingual' => [
                ...
                'langClassName' => EmpowermentProductsLang::className(),
                'tableName' => "{{%empowerment_product_lang}}",
                'attributes' => [
                    'title', 'brief','image', 'content','header_image','header_mobile_image','header_image_title'
                    ,'header_image_brief'
                ]
            ],
        ];
    ...
    /**
     * {@inheritdoc}
     * @return EmpowermentProductsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new EmpowermentProductsQuery(get_called_class());
    }
    ...
    public function getCategory()
    {
        return $this->hasOne(DropdownList::class,['id' => 'category_id'])
                    ...
                    ->onCondition([
                                    ...
                                    'category' => DropdownList::EMPOWERMENT_PRODUCTS,
                                ]);
    }
    ...
    {
        $items = DropdownList::find()->active()->andWhere(['category' => DropdownList::EMPOWERMENT_PRODUCTS])->all();
        return ArrayHelper::map($items, "id","title");
    }

    public function getCategorySearchList()
    {
        $items = DropdownList::find()->active()->andWhere(['category' => DropdownList::EMPOWERMENT_PRODUCTS])->all();
    ...
    public static function getSortItems()
    {
        return
        [
            [
                'value' => 'slug-'. SORT_DESC,
                'view' => Yii::t("site","BY_NAME_DESCENDING")
            ],

            [
                'value' => 'slug-'. SORT_ASC,
                'view' => Yii::t("site","BY_NAME_ASCENDING")
            ],
    ...
    {
        return ArrayHelper::map(self::getSortItems(),"value","view");
        }
