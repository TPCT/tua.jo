...
class ManageController extends BaseController
{
    ...
    {
        $this->layout = '@backend/modules/yeesoft/yii2-yee-media/views/layouts/main';
        
        $params = Yii::$app->request->get();
        $multiple = isset($params["multiple"])? $params["multiple"] : false ; 

        return $this->render('index',['multiple'=>$multiple]);
    }
     ...
     * @return string
     */
    public function actionAddMultiple($id, $strictThumb = null)
    {
        $tableName = Media::tableName();
        ...
        return json_encode(["url"=>$model->url,"id"=>$model->id]);
    }
}