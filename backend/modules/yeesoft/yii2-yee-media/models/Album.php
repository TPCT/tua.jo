...
class Album extends ActiveRecord implements OwnerAccess
{
    ...
    {
        return [
            [['category_id', 'title', 'description', 'slug', 'cover_image', 'created_by', 'updated_by', 'created_at', 'updated_at', 'category_id', 'visible'], function ($attribute) {
                $this->$attribute = \yii\helpers\HtmlPurifier::process($this->$attribute);
            }],
            [['category_id', 'title'/*, 'cover_image'*/], 'required'],
            [['created_by', 'updated_by', 'created_at', 'updated_at', 'category_id', 'visible'], 'integer'],
            [['description'], 'string'],
            [['slug', 'title', 'cover_image'], 'string', 'max' => 255],
        ];
    }
