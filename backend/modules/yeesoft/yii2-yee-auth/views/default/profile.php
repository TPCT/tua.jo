...
<div class="profile-index">
    ...
    <div class="row" style="margin-bottom: 20px;">
        ...
        <div class="text-end col-md-<?= $col3 ?>">
            ...
            <div class="image-uploader">
                ...
                <div class="image-actions">
                    <span class="btn btn-primary btn-file"
                          title="<?= Yii::t('yee/auth', 'Change profile picture') ?>" data-bs-toggle="tooltip"
                          data-placement="left">
                    ...
                    <span class="btn btn-primary image-remove"
                          ...
                          title="<?= Yii::t('yee/auth', 'Remove profile picture') ?>" data-bs-toggle="tooltip"
            ...
            <div class="oauth-services">
                <div class="oauth-authorized-services">
                    <div class="label label-primary space-down"
                         title="<?= Yii::t('yee/auth', 'Click to unlink service') ?>" data-bs-toggle="tooltip"
                         data-placement="right">
                ...
                <div>
                    <div class="label label-primary space-down"
                         title="<?= Yii::t('yee/auth', 'Click to connect with service') ?>" data-bs-toggle="tooltip"
                         data-placement="right">
        ...
        <div class="col-md-<?= $col9 ?>">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-<?= $col3 ?>">
                            <?= $form->field($model, 'gender')->dropDownList(yeesoft\models\User::getGenderList(), ['class'=>'form-select'] ) ?>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-<?= $col3 ?>">
                            <?= $form->field($model, 'birth_month')->dropDownList(YeeHelper::getMonthsList(), ['class'=>'form-select'] ) ?>
                        </div>
                        <div class="col-md-<?= $col3 ?>">
