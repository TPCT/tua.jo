...
class GridView extends \yii\grid\GridView
{
    ...
    public $layout = '{items}<div class="row"><div class="col-sm-4 m-tb-20">{bulkActions}</div><div class="col-sm-5 text-center">{pager}</div><div class="col-sm-3 text-end m-tb-20">{summary}</div></div>';
