...
use backend\behaviors\CustomAuditTrailBehavior;
...
class User extends UserIdentity
{
    ...
    public function behaviors()
    {
        return [
            ...
            //CustomAuditTrailBehavior::className(),
    ...
    {
        return [
            [['username', 'password', 'repeat_password', 'email', 'first_name','last_name','phone','birth_day'
            ,'birth_month','birth_year','gender','info','status','email_confirmed','skype','bind_to_ip'
        ], function ($attribute) {
            ...
            [['username', 'email'], 'required','on' => [self::SCENARIO_NEW_USER,self::SCENARIO_UPDATE_USER]],
            ['username', 'unique'],
...
//            ['username', 'match', 'not' => true, 'pattern' => Yii::$app->yee->usernameBlackRegexp, 'message' => Yii::t('yee/auth', 'Username contains not allowed characters or words.')],
            ...
            ['password', 'required', 'on' => [self::SCENARIO_NEW_USER,'changePassword','updateMyPassword']],
            ...
            [['password'], StrengthValidator::className(),
                ...
                'on' => [self::SCENARIO_NEW_USER,'changePassword','updateMyPassword']
            ],
            ['repeat_password', 'required', 'on' => [self::SCENARIO_NEW_USER,'changePassword']],
            ['repeat_password', 'compare', 'compareAttribute' => 'password'],


//            ['password', 'validatePasswordHistory', 'on' => ['changePassword']],


            ['birth_month', 'in', 'range' => array_keys(YeeHelper::getMonthsList())],
