            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <?= $form->field($model, 'phone')->textInput(['maxlength' => 124]) ?>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <?= $form->field($model, 'gender')->dropDownList(User::getGenderList(), ['class'=>'form-select'] ) ?>
                        </div>
                    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="record-info">
                        <?= $form->field($model->loadDefaultValues(), 'status')->dropDownList(User::getStatusList(), ['class'=>'form-select'] ) ?>
