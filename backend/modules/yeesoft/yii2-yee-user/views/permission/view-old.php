                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="">
                                    <?= Html::checkboxList(
                                        ...
                                        ArrayHelper::map($permissions, 'name', 'action')
                                    ) ?>
                                </div>
                                <br/>
                            </div>
            ...
            <div class="panel panel-default">
				...
				<i class="fa fa-plus"></i> <?= Yii::t('yee/user', 'Show all') ?>
                    ...
                    <?= Html::checkboxList(
                        ...
                        ArrayHelper::map($routes, 'name', 'description'),
                        [
                            'id' => 'routes-list',
                            ...
                            'item' => function ($index, $label, $name, $checked, $value) {
                                return Html::checkbox($name, $checked, [
                                    'value' => $value,
                                    'label' => '<span class="route-text" data-val="'.$value.'">' . $label . '</span>',
...
routeText.each(function(){
    var _t = $(this);
    //console.log(_t.attr("data-val"));

	var chunks = _t.attr("data-val").split('/').reverse();
