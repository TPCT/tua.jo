            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'buttonsTemplate' => '{view} {update} {delete} {revisions} {BMS}',
                        'buttons' => [
                            'revisions' => function ($url, $model, $key) {
                                return $model->revisionButton();
                            },
                            'BMS' => function ($url, $model, $key) {
                                return Html::a(Yii::t('site', 'BMS'),
                                    Url::to(["/{$this->context->module->id}/bms", 'module_id' => $model->id]), [
                                        'title' => Yii::t('site', 'BMS'),
                                        'data-pjax' => '0'
                                    ]
                                );
                            },
