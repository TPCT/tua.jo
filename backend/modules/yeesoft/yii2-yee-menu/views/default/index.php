...
$links = $searchLinkModel->search(['parent_id' => '']);
...
<div class="menu-index">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <?php if ( $links->count  ): ?>
                <?php $menuID = Utility::sanitizeValue( $_GET['SearchMenuLink']['menu_id'] ); ?>
                <?= Html::a(Yii::t('yee/menu', 'Add New Link'), ['/menu/link/create?menu_id=' .  $menuID ], ['class' => 'btn btn-sm btn-primary']) ?>
            <?php else: ?>
