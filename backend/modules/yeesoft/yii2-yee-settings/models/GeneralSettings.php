...
class GeneralSettings extends BaseSettingsModel
{
    ...
    public function rules()
    {
        return ArrayHelper::merge(parent::rules(),
            [
                ...
                [
                    [
                    'title','description', 'og_image', 'email','country','timezone','dateformat','timeformat'
                    ], 
                    function ($attribute) 
                    {
                ...
                [[
                    'title','description', 'og_image', 'email','country','timezone','dateformat','timeformat'], function ($attribute) {
                    $this->$attribute = \yii\helpers\HtmlPurifier::process($this->$attribute);
                }],



                [['title', 'email',  'og_image', 'timezone', 'dateformat', 'timeformat', 'country'], 'required'],
                [['email'], 'email'],
                [['description', 'og_image'], 'safe'],
                ...
                ['timezone', 'in', 'range' => array_keys(GeneralSettings::getTimezones())],
                ['dateformat', 'in', 'range' => array_keys(GeneralSettings::getDateFormats())],
                ['timeformat', 'in', 'range' => array_keys(GeneralSettings::getTimeFormats())],
            ]);
    }
    ...
    public static function getDateFormats()
    {
        ...
        return [
            ...
            'd MMMM Y' => Yii::$app->formatter->asDate($timestamp, "d MMMM Y"),
