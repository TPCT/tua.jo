...
/* @var $searchModel \backend\modules\media_gallery\models\search\MediaGallerySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('site', 'Photo Gallery');
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'title' => function (MediaGallery $model) {
                    ...
                    [
                        ...
                        'filter' => MediaGallery::getCategoryList(),
                    ],
                    [
                        'attribute' => 'created_by',
                        'filter' => User::getUsersList(),
                        'value' => function (MediaGallery $model) {
                            return Html::a('admin',
                    ...
                    [
                        ...
                        'attribute' => 'status',
                        'optionsArray' => MediaGallery::getStatusOptionsList(),
