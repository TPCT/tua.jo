 ...
 *
 * @property OfferedTendersLang    $parent
 */

class OfferedTendersLang extends \yii\db\ActiveRecord
{
...
//            [['parent_id'], 'exist', 'skipOnError' => true, 'targetClass' => News::class, 'targetAttribute' => ['parent_id' => 'id']],
    ...
    {
        return $this->hasOne(OfferedTenders::class, ['id' => 'parent_id']);
    }
