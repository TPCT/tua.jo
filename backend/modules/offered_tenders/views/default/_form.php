...
/* @var $model use backend\modules\zakat_stories\models\ZakatStories; */
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <?= $form->field($model, 'submitting_title')->textInput(['maxlength' => true]) ?>
                    ...
                    <div class="panel-body">
                        ...
                        <?= $form->field($model, 'campaign_id')->dropDownList( \backend\modules\donation_programs\models\DonationProgram::getCampaigns(true), ["prompt"=>"Select Category", 'class' => 'form-select'] ) ?>
                            ...
                            <?php if( $model->canMakerSeeStatus() ): ?>
                                <?= $form->field($model, 'status')->dropDownList(OfferedTenders::getStatusList()) ?>
                            <?php endif; ?>
