...
$this->title = Yii::t('site', 'Transactions');
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'title' => function ($model) {
                            return Html::a($model->first_name . " " . $model->last_name, ["/" . $this->context->module->id . "/default/view", 'id' => $model->id], ['data-pjax' => 0]) ;
                        },
                    ...
                    [
                        'attribute' => 'amount',
                        'value' => function ($model) {
                            return $model->amount . " JOD";
                        }
                    ],
                    [
                        'attribute' => 'status',
                        'value' => function ($model) {
                            return $model->status ? "Accepted" : "Rejected";
                        }
                    ],
                    'type',
                    [
