...
namespace backend\modules\currency_price\controllers;
...
class DefaultController extends BaseController
{
    ...
    public $modelClass = 'backend\modules\currency_price\models\CurrencyPrice';
    public $modelSearchClass = 'backend\modules\currency_price\models\search\CurrencyPriceSearch';
