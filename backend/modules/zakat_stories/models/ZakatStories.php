 ...
 */
class ZakatStories extends ActiveRecord
{
    ...
    public function behaviors()
    {
        return [
            ...
            'multilingual' => [
                ...
                'langClassName' => ZakatStoriesLang::className(),
                'tableName' => "{{%zakat_stories_lang}}",
                'attributes' => [
                    'title', 'brief','second_title','image', 'content','header_image','header_mobile_image','header_image_title'
                    ,'header_image_brief'
                ]
            ],
        ];
    ...
    /**
     * {@inheritdoc}
     * @return ZakatStoriesQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new ZakatStoriesQuery(get_called_class());
    }
    ...
    public function getCategory()
    {
        return $this->hasOne(DropdownList::class,['id' => 'category_id'])
                    ...
                    ->onCondition([
                                    ...
                                    'category' => DropdownList::ZAKAT_CATEGORY,
                                ]);
    }
    ...
    {
        $items = DropdownList::find()->active()->andWhere(['category' => DropdownList::ZAKAT_CATEGORY])->all();
        return ArrayHelper::map($items, "id","title");
    }
