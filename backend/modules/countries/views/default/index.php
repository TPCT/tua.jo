...
/* @var $searchModel \backend\modules\countries\models\search\CountriesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('site', 'Countries');
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'title' => function ($model) {
                            ...
                            return Html::a($model->num_code, ["/" . $this->context->module->id . "/default/view", 'id' => $model->id], ['data-pjax' => 0]);
                        },
