...
/**
 * DefaultController implements the CRUD actions for common\models\testimonials model.
 */
class DefaultController extends BaseController
{
    public $modelClass = 'backend\modules\testimonials\models\Testimonials';
    public $modelSearchClass = 'backend\modules\testimonials\models\search\TestimonialsSearch';
